...
export async function sendBrevoEmail({ to, subject, textContent, htmlContent, replyTo, attachment }) {
  const payload = {
...
export async function upsertBrevoContact({ email, attributes }) {
...
export async function sendFailureAlert(context, detail) {
  try {
